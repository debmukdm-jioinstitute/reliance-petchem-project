            ...
            {conversations.map((c, i) => (
              ...
              >
                ...
                <div className="flex items-center justify-between text-[10px] font-mono text-amber-400 mt-1.5">
                  ...
                  <span className="text-neutral-400 truncate max-w-[120px]">{c.provider || 'RIL Intelligence'}</span>
                </div>
              </div>
            ))}
          </div>
            ...
            {!selectedAnswer && !isLoading && (
              <div className="h-full flex flex-col items-center justify-center text-center p-6 text-xs text-neutral-400 space-y-4">
                ...
                <p className="max-w-md text-sm text-neutral-300 leading-relaxed">
                  Ask any question about Reliance business, macroeconomic trends, microeconomic spreads, cracker kinetics, or site-wide data. Answers are generated by the RIL Intelligence Engine grounded in real-time web intelligence, live market telemetry, and cracker asset records.
                </p>
          ...
          <div className="space-y-2 pt-2 border-t border-neutral-800">
            ...
            <div className="space-y-1.5 text-xs text-neutral-300">
              <div className="flex items-center gap-1.5">
                ...
                <span>Real-Time Web Intelligence: Active</span>
              </div>
              <div className="flex items-center gap-1.5">
