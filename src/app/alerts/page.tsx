...
// Illustrative precedent cases, hand-authored — not generated by a live monitoring
// system. Shows the kind of assumption/scenario updates that should follow a given
// market shock. See /simulation and /scenarios for the actual live-driven calculators.
const ALERTS_DATA: MarketAlert[] = [
  {
    id: 'alert-01',
    triggerEvent: 'Brent crude moves +8.2% over 5 sessions, reaching $97.42/bbl',
    severity: 'HIGH',
  ...
  {
    id: 'alert-02',
    triggerEvent: 'Nagothane pipeline connection milestone slips (+1 month)',
    severity: 'MEDIUM',
  ...
  {
    id: 'alert-03',
    triggerEvent: 'US Mont Belvieu ethane spot firms to $157/t FOB (+3.1% YoY)',
    severity: 'CRITICAL',
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[11px] font-mono tracking-wider uppercase text-[#BFA161] font-semibold flex items-center gap-1.5">
                ...
                Analyst Playbook — Illustrative, Not Live-Generated
              </span>
            </div>
            <h1 className="text-2xl lg:text-3xl font-bold tracking-tight text-[#F8FAFC]">
              MARKET SHOCK PLAYBOOK
            </h1>
            <p className="text-sm text-[#94A3B8] mt-1 font-light max-w-2xl">
              Worked examples of how a market or operational shock should flow through model assumptions and
              scenario outputs. These are hand-authored precedent cases, not a live alert feed — for the
              actual live-driven numbers, see the <a href="/simulation" className="text-[#D4BA7B] hover:underline">Feed-Mix Margin Calculator</a> and{' '}
              <a href="/scenarios" className="text-[#D4BA7B] hover:underline">Scenario Engine</a>.
            </p>
          </div>

          <div className="flex items-center gap-2 text-xs font-mono text-[#94A3B8] bg-[#1A2232]/60 px-3.5 py-2 rounded-lg border border-[#1A2232]">
            <AlertOctagon className="w-3.5 h-3.5" />
            <span>3 Precedent Cases</span>
          </div>
        </div>
